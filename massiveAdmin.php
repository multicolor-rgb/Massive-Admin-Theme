...
#massive uploader on i18n gallery
	...
	register_script('masivescript', $SITEURL.'plugins/massiveAdmin/js/script.js', '2.0', TRUE);
...
add_action( 'settings-sidebar', 'createSideMenu', array( $thisfile, $MenuExternalTitle,'menuext') );
...
add_action('settings-sidebar','createSideMenu',array($thisfile, $HideMassiveTitle,'hideadminsection'));
...
add_action('settings-sidebar','createSideMenu',array($thisfile, $OwnFooterOption,'ownfooteroption'));
...
add_action('settings-sidebar','createSideMenu',array($thisfile,$MassiveAdminSettingTitle,'massiveoption'));
...
add_action('settings-sidebar','createSideMenu',array($thisfile,$helpTitle,'helpdesk'));
